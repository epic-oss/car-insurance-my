...
const myviVariants = [
  {
    variant: "Myvi 1.3 G",
    engine: "1.3L",
    marketValue: "RM45,000",
    comprehensive: "RM800-1,200/year",
    thirdParty: "RM150-250/year",
  },
  {
    variant: "Myvi 1.3 X",
    engine: "1.3L",
    marketValue: "RM50,000",
    comprehensive: "RM850-1,300/year",
    thirdParty: "RM150-250/year",
  },
  {
    variant: "Myvi 1.5 H",
    engine: "1.5L",
    marketValue: "RM55,000",
    comprehensive: "RM900-1,400/year",
    thirdParty: "RM180-280/year",
  },
  {
    variant: "Myvi 1.5 AV",
    engine: "1.5L",
    marketValue: "RM60,000",
    comprehensive: "RM950-1,500/year",
    thirdParty: "RM180-280/year",
  },
];
...
const pricingFactors = [
  {
    ...
    description: "Up to 55% discount if you haven't made claims. This is the biggest factor in reducing your Myvi insurance cost.",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    title: "Coverage Type",
    description: "Comprehensive costs more but covers your Myvi against damage, theft, and accidents.",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    description: "Higher market value means higher premium. Myvi's affordable pricing keeps insurance costs reasonable.",
  },
  {
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const savingTips = [
  ...
  },
  {
    ...
    description: "Prices vary by RM200-500 between insurers for the same Myvi coverage.",
    link: "/calculator/car-insurance-calculator",
    linkText: "Use Calculator",
  },
  {
    title: "Choose Right Coverage",
    description: "Consider Third Party for older Myvi (8+ years) to save significantly.",
...
const bestInsurers = [
  {
    ...
    description: "Competitive rates for Myvi owners with fast digital claims",
  ...
  },
  {
    ...
    name: "Kurnia",
    badge: "Budget Option",
    description: "Affordable premiums for budget-conscious Myvi owners",
    link: "/compare/best-car-insurance-malaysia",
  },
  {
    rank: 5,
    name: "RHB",
    badge: "Banking Customers",
    description: "Great for RHB bank customers with bundled discounts",
    link: "/compare/best-car-insurance-malaysia",
  },
];
...
export default function MyviInsurancePage() {
  const [expandedVariant, setExpandedVariant] = useState<string | null>("myvi-1.3");
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex text-sm text-gray-600">
            ...
            <span className="mx-2">/</span>
            <span className="text-gray-900 font-medium">Myvi Insurance</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Myvi Insurance Price Malaysia 2026
              </h1>
              <p className="text-xl text-gray-300 mb-8">
                Find out how much insurance costs for Perodua Myvi 1.3, 1.5 &amp; Advance models. Compare quotes from 15+ insurers and save up to RM500.
              </p>

              {/* Quick Stats */}
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="bg-white/10 rounded-xl p-4 text-center">
                  <div className="text-2xl font-bold text-secondary-400">From RM600</div>
            ...
            <div className="hidden lg:block">
              <div className="bg-white/10 rounded-2xl p-8 backdrop-blur">
                ...
                <h3 className="text-xl font-bold text-center mb-2">Perodua Myvi</h3>
                <p className="text-center text-gray-300 text-sm">Malaysia&apos;s Best-Selling Car</p>
                <div className="mt-6 space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-300">Engine Options:</span>
                    <span className="font-medium">1.3L / 1.5L</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-300">Price Range:</span>
                    <span className="font-medium">RM45K - RM60K</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-300">Insurance From:</span>
                    <span className="font-medium text-secondary-400">RM600/year</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">
            Myvi Insurance Price Comparison 2026
          </h2>
          <p className="text-gray-600 text-center mb-8 max-w-2xl mx-auto">
            Compare estimated insurance prices for all Perodua Myvi variants. Prices based on 55% NCD.
          </p>
          ...
          <div className="hidden md:block overflow-x-auto">
            <table className="w-full bg-white rounded-xl shadow-lg overflow-hidden">
              <thead className="bg-primary-800 text-white">
                <tr>
                  <th className="px-6 py-4 text-left font-semibold">Myvi Variant</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {myviVariants.map((variant, index) => (
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">
            Factors Affecting Your Myvi Insurance Price
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Understanding these factors helps you find the best myvi insurance price Malaysia offers.
          </p>
      ...
      {/* Myvi Variants Breakdown */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">
            Myvi Insurance by Variant
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Detailed breakdown of perodua myvi insurance price for each variant.
          </p>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
              <button
                onClick={() => setExpandedVariant(expandedVariant === "myvi-1.3" ? null : "myvi-1.3")}
                className="w-full px-6 py-5 text-left flex items-center justify-between hover:bg-gray-50 transition-colors"
              >
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Myvi 1.3 (G &amp; X Variants)</h3>
                  <p className="text-sm text-gray-500">Best for budget-conscious drivers</p>
                </div>
                <div className="flex items-center space-x-4">
                  <span className="text-green-600 font-bold hidden sm:block">From RM800/year</span>
                  <svg
                    className={`w-6 h-6 text-gray-500 transition-transform ${expandedVariant === "myvi-1.3" ? "rotate-180" : ""}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600">
                        <li className="flex justify-between">
                          <span>Engine:</span>
                          <span className="font-medium">1,332cc</span>
                        </li>
                        <li className="flex justify-between">
                          <span>Market Value:</span>
                          <span className="font-medium">RM40,000 - RM55,000</span>
                        </li>
                        <li className="flex justify-between">
                          <span>Road Tax:</span>
                          <span className="font-medium">RM70/year</span>
                        </li>
                        <li className="flex justify-between">
                          <span>Myvi 1.3 Insurance Price:</span>
                          <span className="font-medium text-green-600">RM800 - RM1,200/year</span>
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600">
                        ...
                        <li className="flex items-start space-x-2">
                          ...
                          <span>First-time car owners</span>
                        </li>
                      </ul>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
              <button
                onClick={() => setExpandedVariant(expandedVariant === "myvi-1.5" ? null : "myvi-1.5")}
                className="w-full px-6 py-5 text-left flex items-center justify-between hover:bg-gray-50 transition-colors"
              >
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Myvi 1.5 (H &amp; AV Variants)</h3>
                  <p className="text-sm text-gray-500">Best for highway driving &amp; families</p>
                </div>
                <div className="flex items-center space-x-4">
                  <span className="text-green-600 font-bold hidden sm:block">From RM900/year</span>
                  <svg
                    className={`w-6 h-6 text-gray-500 transition-transform ${expandedVariant === "myvi-1.5" ? "rotate-180" : ""}`}
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mt-6">
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600">
                        <li className="flex justify-between">
                          <span>Engine:</span>
                          <span className="font-medium">1,498cc</span>
                        </li>
                        <li className="flex justify-between">
                          <span>Market Value:</span>
                          <span className="font-medium">RM50,000 - RM65,000</span>
                        </li>
                        <li className="flex justify-between">
                          <span>Road Tax:</span>
                        ...
                        <li className="flex justify-between">
                          <span>Myvi 1.5 Insurance Price:</span>
                          <span className="font-medium text-green-600">RM900 - RM1,500/year</span>
                        </li>
                      </ul>
                    </div>
                    <div>
                      ...
                      <ul className="space-y-2 text-sm text-gray-600">
                        ...
                        <li className="flex items-start space-x-2">
                          ...
                          <span>Families needing more power</span>
                        </li>
                        <li className="flex items-start space-x-2">
                          <svg className="w-5 h-5 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                          </svg>
                          <span>Those wanting Myvi Advance features</span>
                        </li>
                      </ul>
                      <p className="mt-4 text-sm text-gray-500">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">
            Comprehensive vs Third Party for Myvi
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Choosing the right coverage type can save you money while protecting your Perodua Myvi.
          </p>
            ...
            <table className="w-full bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-200">
                <tr className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-medium text-gray-900">Price for Myvi</td>
                  <td className="px-6 py-4 text-center text-green-600 font-semibold">RM800-1,500/year</td>
                  <td className="px-6 py-4 text-center text-blue-600 font-semibold">RM150-280/year</td>
                </tr>
                <tr className="hover:bg-gray-50">
                ...
                <tr className="hover:bg-gray-50 bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-center text-sm">New/financed Myvi<br />(under 8 years old)</td>
                  <td className="px-6 py-4 text-center text-sm">Old Myvi<br />(8+ years old)</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-4 text-center">
            How to Save on Myvi Insurance
          </h2>
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Smart tips to get the lowest myvi insurance price malaysia has to offer.
          </p>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Top 5 recommended insurance companies for Perodua Myvi owners.
          </p>
      ...
      {/* FAQ Section */}
      <FAQ faqs={myviFaqs} title="Myvi Insurance FAQ" />

      {/* CTA Section */}
      <section className="py-16 bg-gradient-to-r from-primary-800 to-primary-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-white mb-8">
            <h2 className="text-3xl font-bold mb-4">Ready to Get Your Myvi Insurance Quote?</h2>
            <p className="text-xl text-gray-300">
              Compare prices from 15+ insurers and save up to RM500 on your Perodua Myvi insurance.
            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-xl p-6 md:p-8 max-w-md mx-auto">
            <LeadForm variant="modal" source="myvi-insurance" />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <h3 className="font-semibold text-gray-900">NCD Explained</h3>
              <p className="text-sm text-gray-500 mt-1">Maximize your discount</p>
            </Link>
            <Link
              href="/guide/third-party-vs-comprehensive"
              className="bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow text-center"
